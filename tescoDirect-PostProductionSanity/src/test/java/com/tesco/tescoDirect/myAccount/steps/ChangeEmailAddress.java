...
public class ChangeEmailAddress {
	...
	private final static Logger LOG = Logger.getLogger(ChangeEmailAddress.class);
	...
	public void I_am_taken_to_the_Change_my_email_address_page() throws Throwable {
		changeEmailAddressPagePO = WC.getPageObject(ChangeEmailAddressPagePO.class);
		Assert.assertTrue(changeEmailAddressPagePO.checkUserIsOnChangeMyEmailAddressPage());
	}
	...
	public void the_following_elements_are_present_on_the_my_email_address_Page(DataTable table) throws Throwable {
		    ...
		    for (Map.Entry<String, String> entry : myValue.entrySet())
		{
		    ...
		    case "Breadcrumbs of the page":
		    	result =changeEmailAddressPagePO.checkBreadcrumbsIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Breadcrumbs of the page is displayed");
		    break;
		    case "Change my email address header text":
		    	result =changeEmailAddressPagePO.checkChangeMyEmailAddressHeaderTextIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Change my email address header text is displayed");
		    break;
		    case "New Email address header text":
		    	result =changeEmailAddressPagePO.checkNewEmailAddressHeaderTextIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("New Email address header text is displayed");
		    break;
		    case "Old Email address label":
		    	result =changeEmailAddressPagePO.checkOldEmailAddressLabelIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Old Email address label");
		    break;
		    case "Old Email address textbox":
		    	result =changeEmailAddressPagePO.checkOldEmailAddressTextboxIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Old Email address textbox is displayed");
		    break;
		    case "Current Email address in Old Email address textbox":
		    	result =changeEmailAddressPagePO.checkCurrentEmailAddressInOldEmailAddressTextboxIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Current Email address in Old Email address textbox is displayed");
		    break;
		    case "Password label":
		    	result =changeEmailAddressPagePO.checkPasswordLabelIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Password label is displayed");
		    break;
		    case "Password textbox":
		    	result =changeEmailAddressPagePO.checkPasswordTextboxIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Password textbox is displayed");
		    break;
		    case "New email address label":
		    	result =changeEmailAddressPagePO.checkNewEmailAddressLabelIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("New email address label is displayed");
		    break;
		    case "New email address textbox":
		    	result =changeEmailAddressPagePO.checkNewEmailAddressTextboxIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("New email address textbox is displayed");
		    break;
		    case "Confirm new email address label":
		    	result =changeEmailAddressPagePO.checkConfirmNewEmailAddressLabelIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Confirm new email address label is displayed");
		    break;
		    case "Confirm new email address textbox":
		    	result =changeEmailAddressPagePO.checkConfirmNewEmailAddressTextboxIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Confirm new email address textbox is displayed");
		    break;
		    case "Cancel Button":
		    	result =changeEmailAddressPagePO.checkCancelButtonIsDisplayed();
		    	Assert.assertTrue(result);
		    	LOG.debug("Cancel Button is displayed");
		    break;
		    case "Save Button":
		    	result =changeEmailAddressPagePO.checkSaveButtonIsDisplayed();
		    	Assert.assertTrue(result);
	...
	public void I_enter_the_current_password_in_the_password_textbox(DataTable table) throws Throwable {
		changeEmailAddressPagePO = WC.getPageObject(ChangeEmailAddressPagePO.class);
		...
		try {
			...
			if (currentPassword != null) {
				...
				changeEmailAddressPagePO.enterCurrentPasswordInThePasswordTextbox(currentPassword);
	...
	public void I_enter_the_following_for_New_email_address(DataTable table) throws Throwable  {
	...
	public void I_enter_the_following_for_Confirm_new_email_address(DataTable table) throws Throwable {
		 {
				...
				try {
					...
					for (int i = 0; i < aux.size(); i++) {
						...
						confirmNewEmailAddress = usrdetails.get("ConfirmNewEmailAddress");
					}

					if (confirmNewEmailAddress != null) {
						
						changeEmailAddressPagePO.enterConfirmNewEmailAddress(confirmNewEmailAddress);
	...
	public void the_emails_do_not_match_error_is_displayed() throws Throwable {
		Assert.assertTrue(changeEmailAddressPagePO.checkEmailMismatchErrorIsDisplayed());
	...
	public void cleanUp(){
		...
		changeEmailAddressPagePO = WC.getPageObject(ChangeEmailAddressPagePO.class);
		Assert.assertTrue(changeEmailAddressPagePO.checkUserIsOnChangeMyEmailAddressPage());
		changeEmailAddressPagePO.enterCurrentPasswordInThePasswordTextbox("Password1");
		changeEmailAddressPagePO.enterNewEmailAddress("ashish.modi@uk.tesco.com");
		changeEmailAddressPagePO.enterConfirmNewEmailAddress("ashish.modi@uk.tesco.com");
		changeEmailAddressPagePO.clickOnSaveButton();
		//aboutYouPagePO = WC.getPageObject(AboutYouPagePO.class);
		//Assert.assertTrue(aboutYouPagePO.checkEmailAddressIsUpdated());
