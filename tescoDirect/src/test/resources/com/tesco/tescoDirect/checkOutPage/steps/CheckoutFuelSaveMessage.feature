@CheckOutPageFuelSaveMessage
Feature: Checkout Page Fuel Save Message

Scenario: Checkout Page Fuel Save Message - Header 
	Given I navigate to TESCO direct "checkout_fuelsavemessage"
...
Scenario: Checkout Page Fuel Save Message - Secure Checkout and Collection Delivery Type 
		Given I navigate to TESCO direct "checkout_fuelsavemessage"
...
Scenario: Checkout Page Fuel Save Message - Home Delivery 
			Given I navigate to TESCO direct "checkout_fuelsavemessage"
...
Scenario: Checkout Page Fuel Save Message - Payment Card 
				Given I navigate to TESCO direct "checkout_fuelsavemessage"
...
Scenario: Checkout Page Fuel Save Message - Voucher block 
					Given I navigate to TESCO direct "checkout_fuelsavemessage"
...
Scenario: Checkout Page Fuel Save Message - Total to pay Block
						Given I navigate to TESCO direct "checkout_fuelsavemessage"
						And I check for the following in Total to pay Block for fuel save message page  
							...
							|Pay now              												|
							|ClubCard points													|
							|This purchase will contribute towards your Clubcard Fuel Savings	|
...
Scenario: Checkout Page Fuel Save Message - Differernt  Payment method 
							Given I navigate to TESCO direct "checkout_fuelsavemessage"
