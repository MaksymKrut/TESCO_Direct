...
public class PDP {
	...
	public void I_goto_the_iPad_PDP_page() throws Throwable {
		...
		homePagePO
				.typeInSearchByProductNameCatalogueNoOrKeywordTextField("482-2411");
	...
	public void the_following_elements_are_displayed(DataTable table)
		...
		hudl2SoftTouchCasePinkPDPPagePO = WC
				.getPageObject(Hudl2SoftTouchCasePinkPDPPagePO.class);
		Boolean result;
		...
		for (Map<String, String> myValue : mappedTable) {
			for (Map.Entry<String, String> entry : myValue.entrySet()) {
				...
				case "Breadcrumbs of the product":
					result = ipadPDPPagePO
							.checkBreadcrumbsOfTheProductIsDisplayed();
				...
				case "Product Catalogue Number":
					result = ipadPDPPagePO
							.checkProductCatalogueNumberIsDisplayed();
					Assert.assertTrue(result);
	...
	public void when_I_goto_the_Hudl2SoftTouchCasePink_PDP_Page()
			throws Throwable {
		ipadPDPPagePO.clickOnSearchByProductNameCatalogueNoOrKeywordTextField();
		ipadPDPPagePO
				.typeInSearchByProductNameCatalogueNoOrKeywordTextField("683-7798");
	...
	public void My_review_overlay_is_displayed() throws Throwable {
		Boolean result = hudl2SoftTouchCasePinkPDPPagePO
				.checkMyReviewOverlayIsDisplayed();
		Assert.assertTrue(result);
	...
	public void the_default_quantity_of_the_Product_Buy_Box_is_1()
			throws Throwable {
		hudl2SoftTouchCasePinkPDPPagePO = WC
				.getPageObject(Hudl2SoftTouchCasePinkPDPPagePO.class);
		Boolean result = hudl2SoftTouchCasePinkPDPPagePO
				.checkBuyBoxDefaultQuantityIs1();
		Assert.assertTrue(result);
	...
	public void I_am_taken_to_the_variant_item_page() throws Throwable {
		...
		Boolean result = hudl2SoftTouchCasePinkPDPPagePO
				.checkVariantItemPageIsDisplayed();
		Assert.assertTrue(result);
