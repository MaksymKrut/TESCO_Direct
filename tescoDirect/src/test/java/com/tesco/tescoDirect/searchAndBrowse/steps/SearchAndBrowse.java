...
public class SearchAndBrowse {
	...
	public void I_click_on_the_Search_by_product_name_catalogue_no_or_Keyword_text_box()
			throws Throwable {
	...
	public void I_type(String characters) throws Throwable {
		...
		homePagePO
				.typeInSearchByProductNameCatalogueNoOrKeywordTextField(characters);
	}

	@Then("^the search suggestion as you type overlay is \"([^\"]*)\" based on the user input$")
	public void the_search_suggestion_as_you_type_overlay_is_based_on_the_user_input(
			String displayedOrNot) throws Throwable {

		Boolean expectedResult = Boolean.valueOf(displayedOrNot);
		Boolean actualResult = homePagePO
				.checkSearchSuggestionAsYouTypeOverLayIsDisplayed();
	...
	public void select_the_respective_item_in_the_search_suggestion_as_you_type_overlay()
			throws Throwable {
	...
	public void I_am_taken_to_the_corresponding(String page) throws Throwable {
		...
		case "Hudl 2 PLP page with pink keyword on item name":
			...
			Assert.assertTrue(hudl2PinkPLPPagePO
					.checkUserIsOnHudl2PinkPLPPage());
			break;
		case "Hudl 2 soft protective Shell Pink PDP page":
			hudl2SoftProtectiveShellPinkPDPPagePO = WC
					.getPageObject(Hudl2SoftProtectiveShellPinkPDPPagePO.class);
			Assert.assertTrue(hudl2SoftProtectiveShellPinkPDPPagePO
					.checkUserIsOnhudl2SoftProtectiveShellPinkPDPPage());
			break;
		case "Hudl2 Soft Touch Case Pink PDP page":
			...
			Assert.assertTrue(hudl2SoftTouchCasePinkPDPPagePO
					.checkUserIsOnHudl2SoftTouchCasePinkPDPPage());
			break;
		}
